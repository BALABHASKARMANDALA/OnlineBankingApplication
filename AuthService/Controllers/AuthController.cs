...
namespace AuthService.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserDetailsDbContext context, IConfiguration config)
        {
            _context = context;
            _config = config;
        }
        ...
        {
            var user = _context.User.FirstOrDefault(c => c.Username == valuser.Username && c.Password == valuser.Password);
            if (user == null)
            {
                return null;
            }
