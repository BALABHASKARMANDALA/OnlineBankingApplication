    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login(UserDetails user)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var response = await httpClient.PostAsync("https://localhost:44392/api/Auth/User", content);
                ...
                using (var response1 = await httpClient.PostAsync("https://localhost:44392/api/Auth/Login", content1))
                {
